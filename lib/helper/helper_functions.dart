...
class HelperFunction {
  ...
  static Future<bool> saveUserPasswordCorrectState(bool isUserPasswordCorrect) async{
    SharedPreferences prefs = await SharedPreferences.getInstance();
  ...
  static Future<bool> saveOnBoardpageViewInSharePreference(bool isViewed) async{
    SharedPreferences prefs = await SharedPreferences.getInstance();
    await prefs.setBool(onBoardPageViewedInSharedPreference, isViewed);
  }

  static Future<bool> saveAssistantVolumeInSharedPreference(double volume) async{
    SharedPreferences prefs = await SharedPreferences.getInstance();
  ...
  static Future<bool> saveUserProfileImageInSharedPreference(String imageUrl) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
